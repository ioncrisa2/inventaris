...
class UpdateKaryawanRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            // Data Identitas
            'nik' => ['required', 'string', 'max:20', Rule::unique('karyawan')->ignore($this->route('karyawan')?->id)],
            ...
            'nomor_ktp' => ['required', 'digits:16', Rule::unique('karyawan', 'nomor_ktp')->ignore($this->route('karyawan')?->id)],
            ...
            'atasan_langsung_id' => [
                ...
                Rule::notIn([$this->route('karyawan')?->id]),
            ],
