...
@section('title', 'Transaksi Gaji - '.$karyawan->nama_lengkap)
...
<x-app-page long-footer>
        ...
        <x-data-table :paginator="$transaksiGaji">
            <x-slot:toolbar>
                <x-filter-form
                    :action="route('transaksi-gaji.karyawan', $karyawan)"
                    :reset-route="route('transaksi-gaji.karyawan', $karyawan)"
                    :has-filters="request()->hasAny(['bulan', 'tahun'])"
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="text-end table-col-width-170">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
