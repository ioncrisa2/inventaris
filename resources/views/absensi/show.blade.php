                    ...
                    <div class="{{ $kondisiKelas }}">
                        ...
                        <button
                            ...
                            <span class="calendar-cell__top">
                                ...
                                @if($cell['libur'])
                                    <span class="calendar-cell-holiday" title="{{ $cell['libur_keterangan'] ?? 'Minggu' }}">Libur</span>
                                @endif
                            </span>
                            @if($badgeStatus)
...
<x-modal-form
    ...
    :data-libur-allowed-statuses="json_encode(\App\Models\Absensi::LIBUR_ALLOWED_STATUSES)"
