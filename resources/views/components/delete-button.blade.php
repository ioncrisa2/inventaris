...
<button type="button" {{ $attributes->merge(['class' => 'btn btn-sm btn-action btn-action-danger']) }}
    aria-label="{{ $label }}" title="Hapus" data-bs-toggle="modal" data-bs-target="#confirmDeleteModal"
    data-delete-url="{{ $url }}" data-delete-message="{{ $deleteMessage }}"
