@props(['icon', 'label', 'value', 'variant' => null, 'compact' => false, 'plain' => false, 'accent' => false])
...
<div
    {{ $attributes->merge(['class' => trim("card summary-card {$variantClass} {$plainClass} {$accentClass} h-100")]) }}>
    <div class="card-body">
