...
<div class="bulk-action-bar" data-bulk-action-bar="{{ $id }}" hidden>
    <div class="bulk-action-bar__form">
        ...
        <div class="bulk-action-bar__actions">
            ...
            @if ($deleteAction)
                <button class="btn btn-sm btn-danger" type="button" data-bulk-delete-trigger data-bs-toggle="modal"
...
@if ($deleteAction)
    <div class="modal fade" id="{{ $modalId }}" tabindex="-1" aria-labelledby="{{ $modalId }}Label"
        aria-hidden="true" data-bulk-delete-modal>
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title fs-5" id="{{ $modalId }}Label">Hapus <span
                            data-bulk-modal-count>0</span> {{ $noun }}?</h2>
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" action="{{ $deleteAction }}" data-bulk-form="{{ $id }}"
